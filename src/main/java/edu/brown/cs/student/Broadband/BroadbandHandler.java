...
/**
 *  sends back the broadband data from the ACS
 *  Census Data API key : 51d2ea8997215acdf626ff79e2cb74c9bc4a56cc
 */
...
//    state and county query parameters
  ...
  private String sendRequest(String county)
    ...
    HttpRequest buildBoredApiRequest =
        HttpRequest.newBuilder()
            .uri(new URI("http://www.boredapi.com/api/activity?participants=" + couunty))
            .GET()
            .build();
